    ...
    arduino.pipe(new serialport.ReadlineParser({ delimiter: '\r\n' })).on('data', async (data) => {
        ...
        if (HABILITAR_OPERACAO_INSERIR) {
            ...
            await poolBancoDados.execute(
                'INSERT INTO leitura (temperatura, umidade, luminosidade, fk_sensores) VALUES (?, ?, ?, 1000)',
                [dht11Temperatura, dht11Umidade, luminosidade]
            );
            console.log("valores inseridos no banco: ", dht11Temperatura + ", " + dht11Umidade + ", " + luminosidade)
